...
--
-- Host: 127.0.0.1
-- Generation Time: May 06, 2020 at 08:30 AM
...
--
-- Dumping data for table `m_hospital`
--

INSERT INTO `m_hospital` (`m_hospital_id`, `m_hospital_name`, `m_hospital_location`, `m_hospital_availableRooms`, `m_hospital_labs`) VALUES
('H123', 'hospital', 'colombo', 7800, '4444444'),
('t6756', 'Asiri+hospital', 'colombo+8', 123, 'many+labs'),
('rg', 'fgddf', 'gfdgf', 44, 'hjghj'),
('356', 'charuka', 'dsfgd', 467, 'hfhfg');
